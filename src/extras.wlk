...
class SacanDinero {method teEncontro() {donal.quitarDinero(self)}}
...
object coronavirus {
    ...
    method teEncontro() {donal.quitarVida(self)}
}
...
object africanosBailarines { 
    ...
    method teEncontro() {donal.quitarElixir()}
}
...
object angela { 
	...
	method teEncontro(){donal.dinero(0)}
}
